...
. **Lund, A.** (2021). *FRESHD: Fast Robust Estimation of Signals in Heterogeneous Data*. R package version 1.0.1. [CRAN](https://cran.r-project.org/web/packages/FRESHD/index.html).
