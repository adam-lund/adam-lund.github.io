...
*If Jon has 10000 covid-19 test kits with $85\%$ accuracy  \pounds $\textsterling 8$ a piece. Assuming each test kit is drawn from an identical independent distribution (i.i.d.), how much does Jon need to spend to get $99\%$ accuracy?*

A little while back a physicist friend came up with this clever Covid-19 themed job interview question for 2020.
...
Finally to help Jon,  specifically for $a^\ast =0.99$ and $a=0.85$ he needs to test $m^\ast=9$ times for a total cost of $72$. Doing that he actually gets around a  $99.5 \%$ accuracy, however he can save 16 if he is willing to accept a slightly lower accuracy around $98.8 \%$.
