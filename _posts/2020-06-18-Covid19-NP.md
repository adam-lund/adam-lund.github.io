...
*If Jon has 10000 covid-19 test kits with $85\%$ accuracy $\pounds 8$ a piece. Assuming each test kit is drawn from an identical independent distribution (i.i.d.), how much does Jon need to spend to get $99\%$ accuracy?*
