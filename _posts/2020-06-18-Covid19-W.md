...
$$\begin{alignat}{4}\tag{2}\label{eq7}
 ...
 with $T_1,T_2,\ldots$ Bernoulli i.i.d.. Then  clearly  $Z_1,Z_2,\ldots$ are i.i.d.  with $Z_j\in\{-\delta,\delta\}$  and it follows that we can write $S_m$ from [(3) from post I](https://adam-lund.github.io/Covid19-NP/#mjx-eqn-eq3new) \eqref{eq3new} as
...
$$\begin{alignat}{4}\tag{6}\label{eq11}
