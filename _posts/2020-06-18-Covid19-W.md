...
{% include image.html url="/assets/number_of_tests.jpg" description="Expected number of trials using the SPRT with 99 $\%$ target accuracy as a function og single test accuracy $a$." %}
